...
public class CarbonFootprintBarGraphsMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carbon_footprint_periodic_data_menu);
        ...
        mViewPager = (ViewPager) findViewById(R.id.container_bar_graph_menu);
        mViewPager.setAdapter(mSectionsPagerAdapter);

        TabLayout tabLayout = (TabLayout) findViewById(R.id.tabs_bar_graph_menu);
